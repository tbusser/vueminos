import type { PlayerScoreMap } from '@/stores/rounds.types';
import type { TurnInput } from '@/stores/turns.types';
...
export const minimumNumberOfPlayers = 2;
export const maximumNumberOfPlayers = 6;
 ...
 */
export function calculateStartingTileBonus(tileValue: number): number {
...
export function calculateTurnScore(turn: TurnInput): number {
...
export function canTileBeTriple(value: number): boolean {
	return value % 3 === 0;
}
 ...
 */
export function determineRoundWinnerAndPoints(
 ...
 */
export function determineTilesPerPlayer(numberOfPlayers: number): number {
